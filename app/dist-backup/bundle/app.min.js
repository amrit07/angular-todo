...
(function () {
    angular.module('myApp').directive('listContainer', function () {
        return {
            ...
            controller: function ($http) {
                ...
                this.addTodo = function () {
                    ...
                    $http.post('/api/v1/todos', itemObj).then(function (response) {
                ...
                this.removeItem = function () {
                    ...
                    console.log("oldList");
                    //$http.delete('/api/v1/todos/:todo_id', function (req, res) {
...
(function () {
    angular.module('listItem').directive('listItem', function () {
